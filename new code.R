...
maleage<-dplyr::select(da,BirdID,HatchDate:LastLiveRecord,Cohort)
...
newdataage$HatchDate<-strptime(newdataage$HatchDate,format="%d/%m/%Y") 
#defining what is the original format of your date
...
LRSm3<-glmer(FledgingNumber~Strategy*LastAge+(1|Sire)+(1|Cohort),data=newdataage,family="poisson")
